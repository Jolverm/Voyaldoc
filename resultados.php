...
<div class="container"> 
  ...
  <!-- inicia contenido resultados de busqueda-->
    ...
    Resultado de 
      ...
      <div class="col-lg-9 col-md-9 hidden-xs resultado"><!-- columna datos de consulta-->
      ...
      </div><!-- termina columna datos de consulta-->    
      
      <div class="col-lg-3 col-md-3 hidden-xs aplicacion">
      HOLA
      </div>
...
<!-- termina contenido resultados de busqueda-->
