  ...
  <div class="tab-content perfil">
    ...
    <div class="tab-pane fade" id="datosContacto">    
        <div class="col-lg-9 col-md-9 cuenta">
            ...
            <form role="form" id="frm-datosContacto">
           ...
           <div class="col-lg-6 col-md-6" style="vertical-align:center">           
           <input type="button" class="btn btn-warning" name="eliminarEsp" id="eliminarEsp" value="Eliminar Especialidad">
           <input type="button" class="btn btn-success" name="agregarEsp" id="agregarEsp" value="Agregar Especialidad">
           </div>
...
<div class="col-lg-4 col-md-6"><input type="checkbox" id="AseguradoraAseguradora51" value="51" name="data[Aseguradora][Aseguradora][]"> <span class="letra"> Mediacces</span></div>
               ...
               </div><!-- cierra row de aseguradoras -->
               <input type="submit" class="btn btn-default" name="continuar" id="continuar" value="Continuar">
            </form>
        </div> 
	<!-- inicia banner lateral -->
...
//]]>--></script><noscript><a href='http://ads.voyaldoc.net/adserver/www/delivery/ck.php?n=afbd56f3&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://ads.voyaldoc.net/adserver/www/delivery/avw.php?zoneid=2&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=afbd56f3' border='0' alt='' /></a></noscript>
    ...
    <!-- termina banner skyscrapper -->	
	<!-- termina banner lateral -->

               
    </div>
    <!-- termina seccion Datos de contacto -->
...
//]]>--></script><noscript><a href='http://ads.voyaldoc.net/adserver/www/delivery/ck.php?n=afbd56f3&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://ads.voyaldoc.net/adserver/www/delivery/avw.php?zoneid=2&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=afbd56f3' border='0' alt='' /></a></noscript>
    ...
    <div class="tab-pane fade" id="consultorios">
        <div class="col-lg-9 col-md-9 consultorios">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 enmedio">    
                	<div class="btn-perfil"><a href="#" class="boton-naranja">Agregar Consultorio</a></div>
                </div>
            </div>
